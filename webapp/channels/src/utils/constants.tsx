...
export const AboutLinks = {
    TERMS_OF_SERVICE: 'https://docs.hanzo.team/terms-of-use/',
    PRIVACY_POLICY: 'https://docs.hanzo.team/privacy-policy/',
};
...
export const CloudLinks = {
    ...
    SELF_HOSTED_SIGNUP: 'https://hanzo.ai/signup',
    DELINQUENCY_DOCS: 'https://docs.hanzo.team/about/cloud-subscriptions.html#failed-or-late-payments',
    SELF_HOSTED_PRICING: 'https://docs.hanzo.team/pricing/#self-hosted',
};

export const HostedCustomerLinks = {
    BILLING_DOCS: 'https://docs.hanzo.team/how-self-hosted-billing-works',
    SELF_HOSTED_BILLING: 'https://docs.hanzo.team/self-hosted-billing',
...
export const DocLinks = {
    ABOUT_TEAMS: 'https://docs.hanzo.team/welcome/about-teams.html#team-url',
    ADVANCED_LOGGING: 'https://docs.hanzo.team/advanced-logging',
    CONFIGURE_DOCUMENT_CONTENT_SEARCH: 'https://docs.hanzo.team/configure-document-content-search',
    CONFIGURE_AD_LDAP_QUERY_TIMEOUT: 'https://docs.hanzo.team/configure-ad-ldap-query-timeout',
    CONFIGURE_OVERRIDE_SAML_BIND_DATA_WITH_LDAP: 'https://docs.hanzo.team/configure-override-saml-bind-data-with-ldap',
    COMPILANCE_EXPORT: 'https://docs.hanzo.team/compliance-export',
    COMPILANCE_MONITORING: 'https://docs.hanzo.team/compliance-monitoring',
    DATA_RETENTION_POLICY: 'https://docs.hanzo.team/data-retention-policy',
    DEFAULT_LDAP_GROUP_SYNC: 'https://docs.hanzo.team/default-ldap-group-sync',
    DESKTOP_MANAGED_RESOURCES: 'https://docs.hanzo.team/desktop-managed-resources',
    ELASTICSEARCH: 'https://docs.hanzo.team/setup-elasticsearch',
    ENABLE_HARDENED_MODE: 'https://docs.hanzo.team/enable-hardened-mode',
    FORMAT_MESSAGES: 'https://docs.hanzo.team/format-messages',
    FILE_STORAGE: 'https://docs.hanzo.team/configure-file-storage',
    GUEST_ACCOUNTS: 'https://docs.hanzo.team/onboard/guest-accounts.html',
    HIGH_AVAILABILITY_CLUSTER: 'https://docs.hanzo.team/high-availability-cluster',
    IN_PRODUCT_NOTICES: 'https://docs.hanzo.team/in-product-notices',
    MULTI_FACTOR_AUTH: 'https://docs.hanzo.team/multi-factor-authentication',
    ONBOARD_ADVANCED_PERMISSIONS: 'https://docs.hanzo.team/advanced-permissions',
    ONBOARD_LDAP: 'https://docs.hanzo.team/setup-ldap',
    SELF_HOSTED_BILLING: HostedCustomerLinks.SELF_HOSTED_BILLING,
    SESSION_LENGTHS: 'https://docs.hanzo.team/configure-session-lengths',
    SETUP_IMAGE_PROXY: 'https://docs.hanzo.team/setup-image-proxy',
    SETUP_LDAP: 'https://docs.hanzo.team/setup-ldap',
    SETUP_PERFORMANCE_MONITORING: 'https://docs.hanzo.team/setup-performance-monitoring',
    SETUP_PUSH_NOTIFICATIONS: 'https://docs.hanzo.team/setup-push-notifications',
    SETUP_SAML: 'https://docs.hanzo.team/administration-guide/onboard/sso-saml.html',
    SHARE_LINKS_TO_MESSAGES: 'https://docs.hanzo.team/share-links-to-messages',
    SITE_URL: 'https://docs.hanzo.team/configure-site-url',
...
export const DeveloperLinks = {
    CUSTOM_SLASH_COMMANDS: 'https://docs.hanzo.team/custom-slash-commands',
    ENABLE_OAUTH2: 'https://docs.hanzo.team/enable-oauth',
    INCOMING_WEBHOOKS: 'https://docs.hanzo.team/incoming-webhooks',
    OUTGOING_WEBHOOKS: 'https://docs.hanzo.team/outgoing-webhooks',
    INTERACTIVE_MESSAGES: 'https://docs.hanzo.team/interactive-messages',
    INTERACTIVE_DIALOGS: 'https://docs.hanzo.team/interactive-dialogs',
    PERSONAL_ACCESS_TOKENS: 'https://docs.hanzo.team/personal-access-tokens',
    PLUGIN_SIGNING: 'https://docs.hanzo.team/sign-plugins',
    PLUGINS: 'https://docs.hanzo.team/plugins',
    SETUP_CUSTOM_SLASH_COMMANDS: 'https://docs.hanzo.team/setup-custom-slash-commands',
    SETUP_INCOMING_WEBHOOKS: 'https://docs.hanzo.team/setup-incoming-webhooks',
    SETUP_OAUTH2: 'https://docs.hanzo.team/setup-oauth-2.0',
    SETUP_OUTGOING_WEBHOOKS: 'https://docs.hanzo.team/setup-outgoing-webhooks',
};
...
export const Constants = {
    ...
    OFFTOPIC_CHANNEL: 'random',
    OFFTOPIC_CHANNEL_UI_NAME: 'random',
    HANZO_SERVICE: 'hanzo',
    GOOGLE_SERVICE: 'google',
    OFFICE365_SERVICE: 'office365',
    OAUTH_SERVICES: ['hanzo', 'google', 'office365', 'openid'],
