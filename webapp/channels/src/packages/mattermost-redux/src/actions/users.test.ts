...
describe('Actions.Users', () => {
    ...
    it('getUserAudits', async () => {
        nock(Client4.getBaseRoute()).
            ...
            query(true).
            reply(200, [{id: TestHelper.generateId(), create_at: 1497285546645, user_id: TestHelper.basicUser!.id, action: '/v1/workspace/users/login', extra_info: 'success', ip_address: '::1', session_id: ''}]);
