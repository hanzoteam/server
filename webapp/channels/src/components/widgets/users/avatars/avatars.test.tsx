...
describe('components/widgets/users/Avatars', () => {
    ...
    test('should support userIds', () => {
        ...
        expect(container.querySelector('img[src="/v1/workspace/users/1/image?_=1620680333191"]')).toBeInTheDocument();
        expect(container.querySelector('img[src="/v1/workspace/users/2/image?_=1620680333191"]')).toBeInTheDocument();
        expect(container.querySelector('img[src="/v1/workspace/users/3/image?_=1620680333191"]')).toBeInTheDocument();
    ...
    test('should properly count overflow', () => {
        ...
        expect(container.querySelector('img[src="/v1/workspace/users/2/image?_=1620680333191"]')).toBeInTheDocument();
        expect(container.querySelector('img[src="/v1/workspace/users/3/image?_=1620680333191"]')).toBeInTheDocument();
        expect(container.querySelector('img[src="/v1/workspace/users/4/image?_=1620680333191"]')).not.toBeInTheDocument();
        expect(container.querySelector('img[src="/v1/workspace/users/5/image?_=1620680333191"]')).not.toBeInTheDocument();
    ...
    test('should fetch missing users', () => {
        ...
        expect(container.querySelector('img[src="/v1/workspace/users/1/image?_=1620680333191"]')).toBeInTheDocument();
        expect(container.querySelector('img[src="/v1/workspace/users/6/image?_=0"]')).toBeInTheDocument();
        expect(container.querySelector('img[src="/v1/workspace/users/7/image?_=0"]')).toBeInTheDocument();
    });
});
