...
describe('components/FileInfoPreview', () => {
    test('should match snapshot, can download files', () => {
        const {container} = renderWithContext(
            <FileInfoPreview
                fileUrl='https://pre-release.mattermost.com/v1/workspace/files/rqir81f7a7ft8m6j6ej7g1txuo'
    ...
    test('should match snapshot, cannot download files', () => {
        const {container} = renderWithContext(
            <FileInfoPreview
                fileUrl='https://pre-release.mattermost.com/v1/workspace/files/aasf9afshaskj1asf91jasf0a0'
