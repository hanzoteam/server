                ...
                <div className='admin-console__wrapper'>
                    <div className='admin-console__content'>
                        ...
                        <AdminPanel
                            ...
                            subtitle={defineMessage({id: 'admin.group_settings.group_detail.groupUsersDescription', defaultMessage: 'Listing of users in Hanzo Team associated with this group.'})}
                        >
                            <GroupUsers
                                members={members}
                                total={memberCount}
