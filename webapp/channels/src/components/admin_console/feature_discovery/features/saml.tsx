    ...
    return (
        <FeatureDiscovery
            ...
            title={defineMessage({
                ...
                defaultMessage: 'Integrate SAML 2.0 with Hanzo Team',
            })}
            copy={defineMessage({
                id: 'admin.saml_feature_discovery.copy',
                defaultMessage: 'When you connect Hanzo Team with your organization\'s single sign-on provider, users can access Hanzo Team without having to re-enter their credentials.',
            })}
