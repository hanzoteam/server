            ...
            <>
                ...
                {(!this.props.isCloud) && (<p className='trial-legal-terms'>
                    ...
                    <FormattedMessage
                        ...
                        defaultMessage='By clicking <highlight>Start trial</highlight>, I agree to the <linkEvaluation>Hanzo Team Software Evaluation Agreement</linkEvaluation>, <linkPrivacy>Privacy Policy</linkPrivacy> and receiving product emails.'
                        values={{
