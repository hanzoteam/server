    ...
    if (status === DesktopAuthStatus.LoggedIn) {
        ...
        subMessage = (
            <FormattedMessage
                ...
                defaultMessage='Click on <b>Open Hanzo Team</b> in the browser prompt to <a>launch the desktop app</a>'
                values={{
        ...
        bottomMessage = (
            <FormattedMessage
                ...
                defaultMessage='Having trouble logging in? <a>Open Hanzo Team in your browser</a>'
                values={{
                    a: (chunks: React.ReactNode) => {
                        return (
