...
test.describe('System Console - Admin User Profile Editing', () => {
    test.beforeEach(async ({pw}) => {
        ...
        await systemConsolePage.page.route('**/v1/workspace/custom_profile_attributes/fields', async (route) => {
            await route.fulfill({
                status: 200,
        ...
        await systemConsolePage.page.unroute('**/v1/workspace/custom_profile_attributes/fields').catch(() => {});
    });
