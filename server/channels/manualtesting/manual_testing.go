...
import (
	...
	"github.com/hanzoai/team/server/v8/channels/app/slashcommands"
...
func ManualTest(c *web.Context, w http.ResponseWriter, r *http.Request) {
	...
	if ok1 && ok2 {
		...
		channel := &model.Channel{DisplayName: "general", Name: model.DefaultChannelName, Type: model.ChannelTypeOpen, TeamId: createdTeam.Id}
