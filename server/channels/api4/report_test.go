...
func TestGetPostsForReporting(t *testing.T) {
	...
	t.Run("should return bad request when license is not Enterprise", func(t *testing.T) {
		...
		resp, _ := doPostJSON(t, th.SystemAdminClient, "/v1/workspace/reports/posts", requestBody)
	...
	t.Run("should return forbidden error when user lacks permission", func(t *testing.T) {
		...
		resp, _ := doPostJSON(t, th.Client, "/v1/workspace/reports/posts", requestBody)
	...
	t.Run("should return posts when system admin makes request", func(t *testing.T) {
		...
		resp, body := doPostJSON(t, th.SystemAdminClient, "/v1/workspace/reports/posts", requestBody)
	...
	t.Run("should handle cursor pagination correctly", func(t *testing.T) {
		...
		resp1, body1 := doPostJSON(t, th.SystemAdminClient, "/v1/workspace/reports/posts", requestBody1)
		...
		resp2, body2 := doPostJSON(t, th.SystemAdminClient, "/v1/workspace/reports/posts", requestBody2)
