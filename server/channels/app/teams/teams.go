...
func (ts *TeamService) createDefaultChannels(rctx request.CTX, teamID string) ([]*model.Channel, error) {
	displayNames := map[string]string{
		model.DefaultChannelName: i18n.T("api.channel.create_default_channels.town_square"),
		model.RandomChannelName:  i18n.T("api.channel.create_default_channels.off_topic"),
	}
