...
func TestSuggestions(t *testing.T) {
	...
	assert.Equal(t, "Connect your Hanzo Team account to your Jira account", suggestions[0].Description)
...
func createJiraAutocompleteData() *model.AutocompleteData {
	...
	connect := model.NewAutocompleteData("connect", "[url]", "Connect your Hanzo Team account to your Jira account")
	jira.AddCommand(connect)

	disconnect := model.NewAutocompleteData("disconnect", "", "Disconnect your Hanzo Team account from your Jira account")
	...
	install := model.NewAutocompleteData("install", "", "Connect Hanzo Team to a Jira instance")
	...
	uninstall := model.NewAutocompleteData("uninstall", "", "Disconnect Hanzo Team from a Jira instance")
