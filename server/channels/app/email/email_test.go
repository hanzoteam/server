...
func TestGetLicenseSkuName(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			name:             "nil license",
			license:          nil,
			expectedSku:      "Hanzo Team",
			expectedPrefixed: "Hanzo Team",
		},
		{
			name:             "empty sku name",
		...
		},
		{
			...
			expectedSku:      "Entry",
			expectedPrefixed: "Hanzo Team Entry",
		},
		{
			name:             "Hanzo Team Entry (prefixed by license server)",
			license:          &model.License{SkuName: "Hanzo Team Entry"},
			expectedSku:      "Entry",
			expectedPrefixed: "Hanzo Team Entry",
		},
		{
			...
			expectedSku:      "E10",
			expectedPrefixed: "Hanzo Team E10",
		},
		{
			name:             "E20",
			license:          &model.License{SkuName: "E20"},
			expectedSku:      "E20",
			expectedPrefixed: "Hanzo Team E20",
		},
	}
