...
const baseManifestJSON = `{
  ...
  "name": "Hanzo Team",
  "short_name": "Hanzo Team",
  "orientation": "any",
  "display": "standalone",
  "start_url": ".",
  "description": "Hanzo Team is an open source, self-hosted Slack-alternative",
