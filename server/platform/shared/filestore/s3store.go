...
type S3FileBackend struct {
	...
	isCloud        bool // field to indicate whether this is running under Hanzo Team cloud or not.
...
// NewS3FileBackend returns an instance of an S3FileBackend and determine if we are in Hanzo Team cloud or not.
