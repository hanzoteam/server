...
// configuration represents the configuration for this plugin as exposed via the Hanzo Team
...
// HelpPlugin implements the interface expected by the Hanzo Team server to communicate
...
func (p *HelpPlugin) OnConfigurationChange() error {
	...
	// Load the public configuration fields from the Hanzo Team server configuration.
