...
// The plugin package is used by Hanzo Team server plugins written in go. It also enables the
// Hanzo Team server to manage and interact with the running plugin environment.
//
