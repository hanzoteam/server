...
// IsE10LicensedOrDevelopment returns true when the server is at least licensed with a legacy Hanzo Team
// Enterprise E10 License or a Hanzo Team License, or has `EnableDeveloper` and
...
// IsE20LicensedOrDevelopment returns true when the server is licensed with a legacy Hanzo Team
// Enterprise E20 License or a Hanzo Team License, or has `EnableDeveloper` and
// `EnableTesting` configuration settings enabled, signaling a non-production, developer mode.
...
// IsEnterpriseAdvancedLicensedOrDevelopment returns true when the server is licensed with a Hanzo Team
