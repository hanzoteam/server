...
type Manifest struct {
	...
	// The minimum Hanzo Team server version required for your plugin.
	//
	...
	// To allow administrators to configure your plugin via the Hanzo Team system console, you can
