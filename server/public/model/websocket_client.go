...
type WebSocketClient struct {
	...
	APIURL             string                  // The API location of the server like "ws://localhost:8065/v1/workspace"
	ConnectURL         string                  // The WebSocket URL to connect to like "ws://localhost:8065/v1/workspace/websocket"
